...
- [x] 倍攻倍防
- [x] 舰船装填倍率，倍率越高，装填越快(3.0.0 或更高)
- [x] 普通移动加速，大世界移动加速
- [x] 移除舰炮开火动画
- [x] 突破连续作战上限
- [x] 移除困难限制：解除舰船类型限制和数值限制
- [x] 移除低心情警告
- [x] 解锁全皮：包括共享皮肤 (3.0.0 或更高) 和宿舍皮肤
- [x] 反和谐：通过hook内在方法来实现，涉及舰船名称、舰船皮肤、誓约(这都被和谐过了?) (3.0.0 或更高)
- [x] 拦截部分作弊数据 (3.0.0 或更高)
# 下载
* 只提供制作方法，不提供成品
* 如果你不会制作成品apk，可以来[这里](https://github.com/JMBQ/azurlane/issues/34)寻找下载链接
* 你使用AL MOD MAKER来自行制作(Release 3.1.0)，关于它的用法不想说太多，只能说不会用就纯属智力问题了
# 用法
